...
import { cancelDriverScheduledRide, getCurrentDriver, getDriverDocumentTemplates, getDriverNotifications, getDriverScheduledRides, getLocalDriverToken, getAuthenticatedDriverRole } from '../services/registrationService';
...
const DriverHome = () => {
    console.log("DRIVER_HOME_ROLE", getAuthenticatedDriverRole());
    ...
    const hydrateDriverState = useCallback(async () => {
        ...
        console.log("DRIVER_PROFILE", driver);
        console.log("PROFILE_ROLE", driver?.role);
        console.log("OWNER_ID", driver?.owner_id);
